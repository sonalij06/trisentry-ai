...
const KEYWORDS = {
  ...
  "sudden-balance-dizziness": ["loss of balance", "can't walk straight", "sudden dizziness", "lack of coordination"],
  "sudden-vision-trouble": ["can't see", "trouble seeing", "sudden vision", "lost vision", "blurry vision suddenly"],
  ...
  "minor-injury": ["sprain", "bruise", "cut", "strain", "twisted my"],
  "mild-digestive": ["upset stomach", "nausea", "mild diarrhea", "queasy"],
  "mild-skin": ["rash", "itchy skin", "skin irritation", "hives"],
  "mild-allergy": ["sneezing", "itchy eyes", "runny nose", "allergies", "hay fever"],
  "mild-headache-tension": ["mild headache", "slight headache", "tension headache"],
  "mild-fatigue-stress": ["tired", "fatigue", "trouble sleeping", "stressed", "can't sleep"],
};
...
export function matchByKeyword(text, rules) {
  ...
  return matched.length > 0 ? matched : [rules.find((r) => r.id === "mild-symptoms")];
}
